...
declare module '$env/static/private' {
	...
	export const PIKTOSTORY_NPM_TOKEN: string;
	...
	export const npm_config__piktostory_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NODE_PATH: string;
		npm_config__piktostory_registry: string;
		XPC_FLAGS: string;
